...
CREATE TABLE public.services (
  ...
  price_type text NOT NULL DEFAULT 'fixed' CHECK (price_type IN ('fixed','hourly','starting_from')),
  delivery_time text,
...
CREATE TABLE public.orders (
  ...
  status text NOT NULL DEFAULT 'pending' CHECK (status IN ('pending','paid','awaiting_confirmation','completed','cancelled','refunded')),
